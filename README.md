...
```
The second most common would downloading through github. 
In the top right of the page click "Code" then, click "Download code through zip", navigate to the location of the file, and extract it
